...
Usage:
    python -m github_profile.transformers.professional [--dry-run] [--backup]
    ou après installation: transform-professional [--dry-run] [--backup]
"""
...
jobs:
  update:
    ...
    steps:
      ...
      - name: Update profile
        run: python -m github_profile.core.updater
      - name: Commit changes
        run: |
